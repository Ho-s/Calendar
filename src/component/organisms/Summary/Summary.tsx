		...
		return (
			<div className='load-list'>
				...
				{Array(7).fill(0).map((n:any, i:number) => {
					const current = m.week(m.week()).startOf('week').add(n + i, 'day')
					const selectedColor = (Number(nowDay) === Number(current.format('D')) && Number(yearStorage) === nowYear && monthStorage === nowMonth) ? '#4D4FFF' : 'gray'
